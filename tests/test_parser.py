...
class TestRawParser(unittest.TestCase):
    ...
    def test_season(self):
        chinese_number_arr = ["一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二"]
        parser = Parser()
        for i in range(1, 13):
    ...
    def test_formatted_title(self):
        cases = [
            ("【幻樱字幕组】【4月新番】【古见同学有交流障碍症 第二季 Komi-san wa, Komyushou Desu. S02】【22】【GB_MP4】【1920X1080】", "Komi-san wa, Komyushou Desu. S2E22"),
            ("[百冬练习组&LoliHouse] BanG Dream! 少女乐团派对！☆PICO FEVER！ / Garupa Pico: Fever! - 26 [WebRip 1080p HEVC-10bit AAC][简繁内封字幕][END] [101.69 MB]", "BanG Dream! 少女乐团派对！☆PICO FEVER！ S1E26"),
            ("【喵萌奶茶屋】★04月新番★[夏日重现/Summer Time Rendering][11][1080p][繁日双语][招募翻译] [539.4 MB]", "Summer Time Rendering S1E11"),
            ("【喵萌奶茶屋】★04月新番★[夏日重现/Summer Time Rendering][01][1080p][繁日双语][招募翻译] [539.4 MB]", "Summer Time Rendering S1E1"),
            ("【喵萌奶茶屋】★04月新番★[夏日重现/Summer Time Rendering][29][1080p][繁日双语][招募翻译] [539.4 MB]", "Summer Time Rendering S1E29"),
            ("【幻樱字幕组】【4月新番】【古见同学有交流障碍症 第一季 Komi-san wa, Komyushou Desu. S01】【31】【GB_MP4】【1920X1080】", "Komi-san wa, Komyushou Desu. S1E31"),
        ]
        parser = Parser()
    ...
    def test_large_data_set(self):
        data = [
            ...
            ("[波洛咖啡厅\PCSUB][相合之物\Deaimon][04][简日\CHS_JP][1080P][MP4_AAC][网盘][招翻译]","相合之物\Deaimon","波洛咖啡厅\PCSUB",4,1),
